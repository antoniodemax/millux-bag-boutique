...
const Navbar = () => {
  ...
  return (
    <nav className="bg-brand-light shadow-lg sticky top-0 z-50 border-b border-brand-accent/20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="relative ml-4 flex items-center px-2 py-2 rounded-md border border-brand-accent/30 text-brand-dark/70 hover:text-brand-primary hover:bg-brand-accent/10 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent/20"
      ...
      {/* Mobile Header - Shows brand, search, cart, and menu button */}
      <div className="md:hidden flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={() => setCartDrawerOpen(!cartDrawerOpen)}
            className="relative p-1 rounded hover:bg-brand-accent/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent/20"
            aria-label="View cart"
          >
          ...
          <button
            ...
            className="p-1 rounded hover:bg-brand-accent/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent/20"
